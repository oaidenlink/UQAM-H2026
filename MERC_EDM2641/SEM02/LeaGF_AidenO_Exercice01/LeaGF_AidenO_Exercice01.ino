/// EXERCICE 1 - EDM2641
// AIDEN OLIVEIRA ET LEA GOUANVIC-FRANCO
...
void setup() {
  pinMode(pinVert, OUTPUT);   // accès a la partie Verte du LED
  pinMode(pinRouge, OUTPUT);  // accès a la partie Rouge du LED
  pinMode(pinBleu, OUTPUT);   // accès a la partie Bleu du LED
}
...
void loop() {
  ...
  // delay(500);
      ...
      /// premier test pour le fondu entre rouge vert et bleu
  // for(int r=0; r<256; r++)
  // {
  ...
  //   }
    ...
    /// Exercice fondu entre les trois couleurs (version legit)
  for(int i=0; i<256; i++)
  {
